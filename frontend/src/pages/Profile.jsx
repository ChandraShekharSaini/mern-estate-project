...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-estate-project-eta.vercel.app/api/user/update/${currentUser._id}`, {
        method: "POST",
        headers: {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-estate-project-eta.vercel.app/api/user/delete/${currentUser._id}`, {
        method: "DELETE",
      });
      const data = await res.json();
      if (data.success === false) {
  ...
  const HandleSingnOut = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-estate-project-eta.vercel.app/api/auth/signout/${currentUser._id}`, {
        method: "GET",
      });
  ...
  const handleShowListing = async () => {
    try {
      ...
      const res = await fetch(`https://mern-estate-project-eta.vercel.app/api/user/listing/${currentUser._id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
