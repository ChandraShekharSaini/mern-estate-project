...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-estate-project-tles.onrender.com/api/user/update/${currentUser._id}`, {
        method: "POST",
        headers: {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-estate-project-tles.onrender.com/api/user/delete/${currentUser._id}`, {
        method: "DELETE",
      });
      const data = await res.json();
      if (data.success === false) {
  ...
  const HandleSingnOut = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-estate-project-tles.onrender.com/api/auth/signout/${currentUser._id}`, {
        method: "GET",
      });
  ...
  const handleShowListing = async () => {
    try {
      ...
      const res = await fetch(`https://mern-estate-project-tles.onrender.com/api/user/listing/${currentUser._id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleListingDelete = async (listingId) => {
    ...
    try {
      const res = await fetch(`https://mern-estate-project-tles.onrender.com/api/listing/delete/${listingId}`, {
        method: "DELETE",
        methods: {
          "Content-Type": "application/json",
        },
