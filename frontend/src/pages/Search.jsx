...
import ListingItem from "../components/ListingIteams";
...
const Search = () => {
  ...
  useEffect(() => {
    ...
    if (searchTermFromUrl || parkingFromUrl || furnishedFromUrl || furnishedFromUrl || offerFromUrl || sortFromUrl || orderFromUrl) {
      setSidebardata({
      ...
      const fetchListings = async () => {
        ...
        const res = await fetch(`https://mern-estate-project-2-5d8i.onrender.com/api/listing/get?${searchQuery}`);
        console.log("jnbjnj")
  ...
  const handleSubmit = (e) => {
    ...
    usenavigate(`/search?${searchQuery}`)
  }
