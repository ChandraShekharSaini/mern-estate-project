...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch(`https://mern-estate-project-2-5d8i.onrender.com/api/listing/get?type=rent&limit=4`);
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch(`https://mern-estate-project-2-5d8i.onrender.com/api/listing/get?type=sale&limit=4`);
        const data = await res.json();
